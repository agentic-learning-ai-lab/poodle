...
def mean_iou(results,
    ...
    """
    total_intersect_and_union_metrics = total_intersect_and_union(results, gt_seg_maps,
                                                                  num_classes, ignore_index,
                                                                  label_map,
                                                                  reduce_zero_label)
    all_acc, acc, iou = eval_metrics(
        total_intersect_and_union_metrics,
        metrics=['mIoU'],
...
def eval_metrics(total_intersect_and_union_metrics,
                 metrics=['mIoU'],
                 nan_to_num=None):
    ...
    total_area_intersect, total_area_union, total_area_pred_label, \
        total_area_label = total_intersect_and_union_metrics
